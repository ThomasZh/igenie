...
@Component
@Controller
public class MyActivityController extends AbstractRestController {
	...
	public Object read(Request request, Response response) {
		...
		try {
			List<Activity> activities = activityService.findJoinedInActivities(accountId, beginTime, prev, pageSize);
			...
			LOGGER.error("Read my activities failed", e);
			throw new ServiceException(e);
		}
	}
