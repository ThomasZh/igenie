...
@Component
@Controller
public class RecommendedActController extends AbstractRestController {
	private static final Logger LOGGER = LoggerFactory.getLogger(RecommendedActController.class);
	@Autowired
	...
	public Object read(Request request, Response response) {
		...
		try {
			List<Activity> activities = activityService.findRecommendedActivities(accountId, beginTime, prev, pageSize);
			...
			LOGGER.error("Read recommended activities failed", e);
			throw new ServiceException(e);
		}
	}
