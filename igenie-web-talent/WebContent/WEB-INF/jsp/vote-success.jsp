			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 photo-bg pad-tb50">
					<div class="my-photo mag-tb10">
						<img class="img-responsive img-circle center-block" src="http://tripc2c-person-face.b0.upaiyun.com/2/5/11/10427ef8-9e34-4bd5-9123-551d96953e73.jpg">
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 act-mag">
							...
							<a href="http://planc2c.com/talent/my-friends.htm"
									class="btn btn-lg btn-primary btn-block active">进入</a>
