...
public class InlinecastApplyStateAdapter
		extends StpReqCommand
{
	public InlinecastApplyStateAdapter()
	{
		super();
	...
	{
		reqCmd = new InlinecastApplyStateReq().decode(tlv);
	...
	public RespCommand execute(ApplicationContext context)
			throws Exception
	{
		GaApplyStateNotify notify = reqCmd.getNotify();
	...
	private InlinecastApplyStateReq reqCmd;

	private final static Logger logger = LoggerFactory.getLogger(InlinecastApplyStateAdapter.class);
