...
public class ActivityQueryMyHistoryPaginationAdapter
		extends StpReqCommand
{
	public ActivityQueryMyHistoryPaginationAdapter()
	{
		super();

		this.setTag(Command.ACTIVITY_QUERY_MY_HISTORY_PAGINATION_REQ);
	}
	...
	{
		reqCmd = new ActivityQueryMyHistoryPaginationReq().decode(tlv);
	...
	public RespCommand execute(ApplicationContext context)
			throws Exception
	{
		ActivityQueryMyHistoryPaginationResp respCmd = null;
		...
		try {
			...
			List<ActivitySubscribeInfo> array = activityService.queryHistoryPagination(getMyAccountId(), today, pageNum,
					pageSize);
			...
			respCmd = new ActivityQueryMyHistoryPaginationResp(ErrorCode.SUCCESS, array);
			...
			respCmd = new ActivityQueryMyHistoryPaginationResp(ErrorCode.UNKNOWN_FAILURE, null);
			respCmd.setSequence(sequence);
			return respCmd;
		}
	}

	private ActivityQueryMyHistoryPaginationReq reqCmd;

	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryMyHistoryPaginationAdapter.class);
