 ...
 * 
 */
public class ActivityQueryAccountFuturePaginationAdapter
		extends StpReqCommand
{
	public ActivityQueryAccountFuturePaginationAdapter()
	{
		super();

		this.setTag(Command.ACTIVITY_QUERY_ACCOUNT_FUTURE_PAGINATION_REQ);
	}
	...
	{
		reqCmd = new ActivityQueryAccountFuturePaginationReq().decode(tlv);
	...
	public RespCommand execute(ApplicationContext context)
			throws Exception
	{
		ActivityQueryAccountFuturePaginationResp respCmd = null;
		...
		try {
			...
			List<ActivitySubscribeInfo> array = activityService.queryCreateFuturePagination(accountId, today, pageNum,
					pageSize);
			...
			respCmd = new ActivityQueryAccountFuturePaginationResp(ErrorCode.SUCCESS, array);
			...
			respCmd = new ActivityQueryAccountFuturePaginationResp(ErrorCode.UNKNOWN_FAILURE, null);
			respCmd.setSequence(sequence);
			return respCmd;
		}
	}

	private ActivityQueryAccountFuturePaginationReq reqCmd;

	private final static Logger logger = LoggerFactory.getLogger(ActivityQueryAccountFuturePaginationAdapter.class);
