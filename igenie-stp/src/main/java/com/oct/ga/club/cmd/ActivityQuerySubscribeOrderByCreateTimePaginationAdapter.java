...
import com.oct.ga.comm.cmd.club.ActivityQuerySubscribeOrderByCreateTimePaginationReq;
...
public class ActivityQuerySubscribeOrderByCreateTimePaginationAdapter
		extends StpReqCommand
{
	public ActivityQuerySubscribeOrderByCreateTimePaginationAdapter()
	{
		super();

		this.setTag(Command.ACTIVITY_QUERY_SUBSCRIBE_ORDER_BY_CREATRE_TIME_PAGINATION_REQ);
	}
	...
	{
		reqCmd = new ActivityQuerySubscribeOrderByCreateTimePaginationReq().decode(tlv);
	...
	public RespCommand execute(ApplicationContext context)
			throws Exception
	{
		ActivityQuerySubscribeOrderByCreateTimePaginationResp respCmd = null;
		...
		try {
			...
			// endTime>today
			List<ActivitySubscribeDetailInfo> array = activityService.querySubscribeOrderByCreateTimePagination(
					this.getMyAccountId(), today, pageNum, pageSize);
			...
			respCmd = new ActivityQuerySubscribeOrderByCreateTimePaginationResp(sequence, ErrorCode.SUCCESS, array);
			return respCmd;
		} catch (Exception e) {
			...
			respCmd = new ActivityQuerySubscribeOrderByCreateTimePaginationResp(sequence, ErrorCode.UNKNOWN_FAILURE,
					null);
			return respCmd;
		}
	}

	private ActivityQuerySubscribeOrderByCreateTimePaginationReq reqCmd;

	private final static Logger logger = LoggerFactory
			.getLogger(ActivityQuerySubscribeOrderByCreateTimePaginationAdapter.class);
