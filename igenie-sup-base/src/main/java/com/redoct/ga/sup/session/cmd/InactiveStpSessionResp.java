...
public class InactiveStpSessionResp
		extends SupRespCommand
{
	public InactiveStpSessionResp()
	{
		this.setTag(SupCommandTag.INACTIVE_STP_SESSION_RESP);
	}

	public InactiveStpSessionResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public InactiveStpSessionResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(InactiveStpSessionResp.class);
