...
public class QueryAccountBasicInfoReq
		extends SupReqCommand
{
	public QueryAccountBasicInfoReq()
	{
		super();
	...
	public QueryAccountBasicInfoReq(String accountId)
	{
		this();
	...
	public QueryAccountBasicInfoReq(long sequence, String accountId)
	{
		this(accountId);
	...
	@Override
	public QueryAccountBasicInfoReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryAccountBasicInfoReq.class);
