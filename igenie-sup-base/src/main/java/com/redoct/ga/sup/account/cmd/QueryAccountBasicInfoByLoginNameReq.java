...
public class QueryAccountBasicInfoByLoginNameReq
		extends SupReqCommand
{
	public QueryAccountBasicInfoByLoginNameReq()
	{
		super();
	...
	public QueryAccountBasicInfoByLoginNameReq(short loginType, String loginName)
	{
		this();
	...
	public QueryAccountBasicInfoByLoginNameReq(long sequence, short loginType, String loginName)
	{
	...
	@Override
	public QueryAccountBasicInfoByLoginNameReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryAccountBasicInfoByLoginNameReq.class);
