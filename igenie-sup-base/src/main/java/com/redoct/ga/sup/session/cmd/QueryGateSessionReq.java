...
public class QueryGateSessionReq
		extends SupReqCommand
{
	public QueryGateSessionReq()
	{
		super();
	...
	public QueryGateSessionReq(String deviceId)
	{
		this();
	...
	public QueryGateSessionReq(long sequence, String deviceId)
	{
		this(deviceId);
	...
	@Override
	public QueryGateSessionReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryGateSessionReq.class);
