...
public class QueryAccountMasterInfoReq
		extends SupReqCommand
{
	public QueryAccountMasterInfoReq()
	{
		super();
	...
	public QueryAccountMasterInfoReq(String accountId)
	{
		this();
	...
	public QueryAccountMasterInfoReq(long sequence, String accountId)
	{
		this(accountId);
	...
	@Override
	public QueryAccountMasterInfoReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryAccountMasterInfoReq.class);
