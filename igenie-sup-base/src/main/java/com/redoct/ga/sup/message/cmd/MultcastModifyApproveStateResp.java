...
public class MultcastModifyApproveStateResp
		extends SupRespCommand
{
	public MultcastModifyApproveStateResp()
	{
		this.setTag(SupCommandTag.MULTCAST_MODIFY_APPLY_STATE_RESP);
	}

	public MultcastModifyApproveStateResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public MultcastModifyApproveStateResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(MultcastModifyApproveStateResp.class);
