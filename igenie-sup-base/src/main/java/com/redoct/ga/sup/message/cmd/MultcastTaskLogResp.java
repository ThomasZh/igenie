...
public class MultcastTaskLogResp
		extends SupRespCommand
{
	public MultcastTaskLogResp()
	{
		this.setTag(SupCommandTag.MULTCAST_TASK_LOG_RESP);
	}

	public MultcastTaskLogResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public MultcastTaskLogResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(MultcastTaskLogResp.class);
