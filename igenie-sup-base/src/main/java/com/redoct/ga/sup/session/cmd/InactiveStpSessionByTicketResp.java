...
public class InactiveStpSessionByTicketResp
		extends SupRespCommand
{
	public InactiveStpSessionByTicketResp()
	{
		this.setTag(SupCommandTag.INACTIVE_STP_SESSION_BY_TICKET_RESP);
	}

	public InactiveStpSessionByTicketResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public InactiveStpSessionByTicketResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(InactiveStpSessionByTicketResp.class);
