...
public class MultcastActivityJoinResp
		extends SupRespCommand
{
	public MultcastActivityJoinResp()
	{
		this.setTag(SupCommandTag.MULTCAST_ACTIVITY_JOIN_RESP);
	}

	public MultcastActivityJoinResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public MultcastActivityJoinResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(MultcastActivityJoinResp.class);
