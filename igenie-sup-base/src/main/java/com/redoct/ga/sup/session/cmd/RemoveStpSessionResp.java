...
public class RemoveStpSessionResp
		extends SupRespCommand
{
	public RemoveStpSessionResp()
	{
		this.setTag(SupCommandTag.REMOVE_STP_SESSION_RESP);
	}

	public RemoveStpSessionResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public RemoveStpSessionResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(RemoveStpSessionResp.class);
