...
public class VerifyGateTokenResp
		extends SupRespCommand
{
	public VerifyGateTokenResp()
	{
		this.setTag(SupCommandTag.VERIFY_GATE_TOKEN_RESP);
	}

	public VerifyGateTokenResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public VerifyGateTokenResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(VerifyGateTokenResp.class);
