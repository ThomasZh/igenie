...
public class RemoveStpSessionByTicketResp
		extends SupRespCommand
{
	public RemoveStpSessionByTicketResp()
	{
		this.setTag(SupCommandTag.REMOVE_STP_SESSION_BY_TICKET_RESP);
	}

	public RemoveStpSessionByTicketResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public RemoveStpSessionByTicketResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(RemoveStpSessionByTicketResp.class);
