...
public class RemoveStpSessionByTicketReq
		extends SupReqCommand
{
	public RemoveStpSessionByTicketReq()
	{
		super();

		this.setTag(SupCommandTag.REMOVE_STP_SESSION_BY_TICKET_REQ);
	}

	public RemoveStpSessionByTicketReq(String sessionTicket)
	{
		this();
	...
	public RemoveStpSessionByTicketReq(long sequence, String sessionTicket)
	{
		this(sessionTicket);
	...
	@Override
	public RemoveStpSessionByTicketReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(RemoveStpSessionByTicketReq.class);
