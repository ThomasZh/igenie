...
public class VerifyLoginExistResp
		extends SupRespCommand
{
	public VerifyLoginExistResp()
	{
		this.setTag(SupCommandTag.VERIFY_LOGIN_EXIST_RESP);
	}

	public VerifyLoginExistResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public VerifyLoginExistResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(VerifyLoginExistResp.class);
