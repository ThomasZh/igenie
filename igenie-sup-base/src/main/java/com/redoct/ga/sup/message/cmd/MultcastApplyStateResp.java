...
public class MultcastApplyStateResp
		extends SupRespCommand
{
	public MultcastApplyStateResp()
	{
		this.setTag(SupCommandTag.MULTCAST_APPLY_STATE_RESP);
	}

	public MultcastApplyStateResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public MultcastApplyStateResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(MultcastApplyStateResp.class);
