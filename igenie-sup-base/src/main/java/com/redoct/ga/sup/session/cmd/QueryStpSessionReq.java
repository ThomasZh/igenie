...
public class QueryStpSessionReq
		extends SupReqCommand
{
	public QueryStpSessionReq()
	{
		super();
	...
	public QueryStpSessionReq(String accountId)
	{
		this();
	...
	public QueryStpSessionReq(long sequence, String accountId)
	{
		this(accountId);
	...
	@Override
	public QueryStpSessionReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryStpSessionReq.class);
