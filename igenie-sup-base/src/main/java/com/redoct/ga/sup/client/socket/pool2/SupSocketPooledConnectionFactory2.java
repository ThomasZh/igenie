...
public class SupSocketPooledConnectionFactory2
		extends BasePooledObjectFactory<IoSession>
{
	...
	public SupSocketPooledConnectionFactory2(String hostname, int port)
	{
			...
			throws Exception
	{
		...
		connector.setHandler(new SupSocketEventHandler2());
	...
	private final static Logger logger = LoggerFactory.getLogger(SupSocketPooledConnectionFactory2.class);
}
