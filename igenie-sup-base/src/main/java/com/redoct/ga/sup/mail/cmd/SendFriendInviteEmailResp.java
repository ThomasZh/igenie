...
public class SendFriendInviteEmailResp
		extends SupRespCommand
{
	public SendFriendInviteEmailResp()
	{
		this.setTag(SupCommandTag.SEND_FRIEND_INVTE_EMAIL_RESP);
	}

	public SendFriendInviteEmailResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public SendFriendInviteEmailResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(SendFriendInviteEmailResp.class);
