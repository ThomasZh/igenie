...
public class QueryAccountBasicInfoByLoginNameResp
		extends SupRespCommand
{
	public QueryAccountBasicInfoByLoginNameResp()
	{
		super();

		this.setTag(SupCommandTag.QUERY_ACCOUNT_INFO_BY_LOGIN_NAME_RESP);
	}

	public QueryAccountBasicInfoByLoginNameResp(long sequence, short state)
	{
		this();
	...
	public QueryAccountBasicInfoByLoginNameResp(long sequence, short state, AccountBasic account)
	{
		this(sequence, state);
	...
	@Override
	public QueryAccountBasicInfoByLoginNameResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryAccountBasicInfoByLoginNameResp.class);
