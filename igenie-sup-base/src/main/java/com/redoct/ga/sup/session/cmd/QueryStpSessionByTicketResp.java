...
public class QueryStpSessionByTicketResp
		extends SupRespCommand
{
	public QueryStpSessionByTicketResp()
	{
		this.setTag(SupCommandTag.QUERY_STP_SESSION_BY_TICKET_RESP);
	}

	public QueryStpSessionByTicketResp(long sequence, short respState)
	{
		this();
	...
	public QueryStpSessionByTicketResp(long sequence, short respState, StpSession stpSession)
	{
		this();
	...
	@Override
	public QueryStpSessionByTicketResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(QueryStpSessionByTicketResp.class);
