...
public class ModifyAccountBasicInfoResp
		extends SupRespCommand
{
	public ModifyAccountBasicInfoResp()
	{
		this.setTag(SupCommandTag.MODIFY_ACCOUNT_INFO_RESP);
	}

	public ModifyAccountBasicInfoResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public ModifyAccountBasicInfoResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ModifyAccountBasicInfoResp.class);
