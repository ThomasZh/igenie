		...
		extends SupRespCommand
{
	...
	{
		this.setTag(SupCommandTag.SEND_SMS_VERIFICATION_RESP);
	}

	public SendVerificationCodeResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public SendVerificationCodeResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(SendVerificationCodeResp.class);
