...
public class CreateLoginResp
		extends SupRespCommand
{
	public CreateLoginResp()
	{
		this.setTag(SupCommandTag.CREATE_LOGIN_RESP);
	}

	public CreateLoginResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public CreateLoginResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(CreateLoginResp.class);
