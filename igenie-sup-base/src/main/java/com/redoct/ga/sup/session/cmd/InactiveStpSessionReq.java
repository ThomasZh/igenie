...
public class InactiveStpSessionReq
		extends SupReqCommand
{
	public InactiveStpSessionReq()
	{
		super();
	...
	public InactiveStpSessionReq(String accountId)
	{
		this();
	...
	public InactiveStpSessionReq(long sequence, String accountId)
	{
		this(accountId);
	...
	@Override
	public InactiveStpSessionReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(InactiveStpSessionReq.class);
