...
public class ModifyPwdResp
		extends SupRespCommand
{
	public ModifyPwdResp()
	{
		this.setTag(SupCommandTag.MODIFY_PWD_RESP);
	}

	public ModifyPwdResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public ModifyPwdResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ModifyPwdResp.class);
