...
public class CreateLostPwdEkeyReq
		extends SupReqCommand
{
	public CreateLostPwdEkeyReq()
	{
		super();

		this.setTag(SupCommandTag.CREATE_LOST_PWD_EKEY_REQ);
	}

	public CreateLostPwdEkeyReq(short loginType, String loginName)
	{
		this();
	...
	public CreateLostPwdEkeyReq(long sequence, short loginType, String loginName)
	{
	...
	@Override
	public CreateLostPwdEkeyReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(CreateLostPwdEkeyReq.class);
