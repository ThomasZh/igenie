...
public class ModifyAccountId4LoginResp
		extends SupRespCommand
{
	public ModifyAccountId4LoginResp()
	{
		this.setTag(SupCommandTag.MODIFY_ACCOUNT_LOGIN_RESP);
	}

	public ModifyAccountId4LoginResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public ModifyAccountId4LoginResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ModifyAccountId4LoginResp.class);
