...
public class ActiveStpSessionByTicketResp
		extends SupRespCommand
{
	public ActiveStpSessionByTicketResp()
	{
		this.setTag(SupCommandTag.ACTIVE_STP_SESSION_BY_TICKET_RESP);
	}

	public ActiveStpSessionByTicketResp(long sequence, short respState)
	{
		this();
	...
	public ActiveStpSessionByTicketResp(long sequence, short respState, StpSession stpSession)
	{
		this();
	...
	@Override
	public ActiveStpSessionByTicketResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ActiveStpSessionByTicketResp.class);
