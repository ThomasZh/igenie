...
public class SendHtmlEmailResp
		extends SupRespCommand
{
	public SendHtmlEmailResp()
	{
		this.setTag(SupCommandTag.SEND_HTML_EMAIL_RESP);
	}

	public SendHtmlEmailResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public SendHtmlEmailResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(SendHtmlEmailResp.class);
