...
{
	public CreateLoginReq()
	{
		super();

		this.setTag(SupCommandTag.CREATE_LOGIN_REQ);
	}

	public CreateLoginReq(String accountId, short loginType, String loginName)
	{
		this();
	...
	public CreateLoginReq(long sequence, String accountId, short loginType, String loginName)
	{
	...
	@Override
	public CreateLoginReq decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(CreateLoginReq.class);
}
