		...
		extends SupRespCommand
{
	...
	{
		this.setTag(SupCommandTag.CREATE_ACCOUNT_RESP);
	}

	public CreateAccountResp(long sequence, short respState)
	{
		this();
	...
	public CreateAccountResp(long sequence, short respState, String accountId)
	{
	...
	@Override
	public CreateAccountResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(CreateAccountResp.class);
