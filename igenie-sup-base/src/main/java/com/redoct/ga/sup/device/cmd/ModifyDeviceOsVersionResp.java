...
public class ModifyDeviceOsVersionResp
		extends SupRespCommand
{
	public ModifyDeviceOsVersionResp()
	{
		this.setTag(SupCommandTag.MODIFY_DEVICE_OS_VERSION_RESP);
	}

	public ModifyDeviceOsVersionResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public ModifyDeviceOsVersionResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ModifyDeviceOsVersionResp.class);
