...
public class ApplyVerificationCodeResp
		extends SupRespCommand
{
	public ApplyVerificationCodeResp()
	{
		this.setTag(SupCommandTag.APPLY_VERIFICATION_CODE_RESP);
	}

	public ApplyVerificationCodeResp(long sequence, short respState)
	{
		this();
	...
	public ApplyVerificationCodeResp(long sequence, short respState, String ekey)
	{
	...
	@Override
	public ApplyVerificationCodeResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ApplyVerificationCodeResp.class);
