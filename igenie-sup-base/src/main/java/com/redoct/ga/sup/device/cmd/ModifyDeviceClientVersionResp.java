...
public class ModifyDeviceClientVersionResp
		extends SupRespCommand
{
	public ModifyDeviceClientVersionResp()
	{
		this.setTag(SupCommandTag.MODIFY_DEVICE_CLIENT_VERSION_RESP);
	}

	public ModifyDeviceClientVersionResp(long sequence, short respState)
	{
		this();
	...
	@Override
	public ModifyDeviceClientVersionResp decode(TlvObject tlv)
	...
	private final static Logger logger = LoggerFactory.getLogger(ModifyDeviceClientVersionResp.class);
