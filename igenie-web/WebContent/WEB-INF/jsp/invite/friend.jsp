	...
	function init() {
		...
		if (is_weixin()) {
			...
			if (browser.versions.ios || browser.versions.iPhone || browser.versions.iPad) {
				...
				imageControl.setAttribute("src", "http://tripc2c-default.b0.upaiyun.com/app/image/wechat-tips-ios.png");
				guideDiv.appendChild(imageControl);
				
				var buttonControl = document.createElement("input");
				buttonControl.setAttribute("type", "Submit");
				buttonControl.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				buttonControl.setAttribute("onclick", "javascript:_system._guide(true)");
				buttonControl.setAttribute("value", "下载 iOS客户端");
				...
				buttonControl3.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				buttonControl3.setAttribute("onclick", "javascript:_system._guide(true)");
				buttonControl3.setAttribute("value", "打开 iOS客户端");
				downloadDiv.appendChild(buttonControl3);
			} else if (browser.versions.android) {
				var imageControl = document.createElement("img");
				imageControl.setAttribute("src", "http://tripc2c-default.b0.upaiyun.com/app/image/wechat-tips-android.png");
				guideDiv.appendChild(imageControl);
				...
				buttonControl.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				buttonControl.setAttribute("onclick", "javascript:_system._guide(true)");
				buttonControl.setAttribute("value", "下载 Android客户端");
				downloadDiv.appendChild(buttonControl);
				...
				buttonControl3.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				buttonControl3.setAttribute("onclick", "javascript:_system._guide(true)");
				buttonControl3.setAttribute("value", "打开 Android客户端");
				downloadDiv.appendChild(buttonControl3);
			} else {
				var imageControl = document.createElement("img");
				imageControl.setAttribute("src", "http://tripc2c-default.b0.upaiyun.com/app/image/wechat-tips-android.png");
				...
				buttonControl3.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				buttonControl3.setAttribute("onclick", "javascript:_system._guide(true)");
				buttonControl3.setAttribute("value", "下载 Android客户端");
				downloadDiv.appendChild(buttonControl3);
			}
		} else {
			if (browser.versions.ios || browser.versions.iPhone || browser.versions.iPad) {
				...
				buttonControl.innerHTML = "下载 iOS客户端";
				downloadDiv.appendChild(buttonControl);

				var buttonControl2 = document.createElement("a");
				buttonControl2.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				buttonControl2.setAttribute("href", "Aplan://fm?ekey=" + ekey);
				buttonControl2.innerHTML = "打开 iOS客户端";
				...
				buttonControl.innerHTML = "下载 Android客户端";
				downloadDiv.appendChild(buttonControl);

				var buttonControl2 = document.createElement("a");
				buttonControl2.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				buttonControl2.setAttribute("href", "Aplan://fm?ekey=" + ekey);
				buttonControl2.innerHTML = "打开 Android客户端";
				downloadDiv.appendChild(buttonControl2);
			} else {				
				var buttonControl = document.createElement("a");
				buttonControl.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				...
				var buttonControl2 = document.createElement("a");
				buttonControl2.setAttribute("class", "btn btn-lg btn-primary btn-block active");
				buttonControl2.setAttribute("href", "http://tripc2c-default.b0.upaiyun.com/app/install/Aplan.apk");
				buttonControl2.innerHTML = "下载 Android客户端";
				downloadDiv.appendChild(buttonControl2);
			}
		}
	}
...
<body>
	...
	<c:if test="${'notExist' == rs}">This invite not exist!</c:if>
	<!-- if condition -->
	<c:if test="${'ok' == rs}">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 photo-bg pad-tb50">
					<div class="my-photo mag-tb10">
					  <c:if test="${friendImageUrl == null}">
						<img class="img-responsive img-circle center-block" src="http://tripc2c-default.b0.upaiyun.com/app/image/avatar.png">
					  </c:if>
					  <c:if test="${friendImageUrl != null}">
						<img class="img-responsive img-circle center-block" src="${friendImageUrl}">
					  </c:if>
					</div>
					<h4 class="mag-tb10 txt-col-white text-center">${friendName}</h4>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 act-mag">
							<div class="row">
								<h4 class="act-title col-xs-12 col-sm-12 col-md-12">
									<strong>邀请您加为好友！</strong>
								</h4>
								<div class="col-xs-12 col-sm-12 col-md-12 times">
									<a
									href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxaa328c83d3132bfb&redirect_uri=http://planc2c.com/m/invite/addfriend.htm?ekey=${ekey}&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect"
									class="btn btn-lg btn-success btn-block active">加为好友</a>
									</div>
